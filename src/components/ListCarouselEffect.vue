<template>
  <div class="row">
    <div class="col-sm-6 col-md-3 mb-2 d-flex justify-content-center">
      <button
        :class="filterclass == 99 ? 'btn-active' : 'btn-default'"
        @click="filters('99')">
        All
      </button>
    </div>
    <div class="col-sm-6 col-md-3 mb-2 d-flex justify-content-center">
      <button
        :class="filterclass == 1 ? 'btn-active' : 'btn-default'"
        @click="filters('1')">
        Land animals
      </button>
    </div>
    <div class="col-sm-6 col-md-3 mb-2 d-flex justify-content-center">
      <button
        :class="filterclass == 2 ? 'btn-active' : 'btn-default'"
        @click="filters('2')">
        Aquatic
      </button>
    </div>
    <div class="col-sm-6 col-md-3 mb-2 d-flex justify-content-center">
      <button
        :class="filterclass == 3 ? 'btn-active' : 'btn-default'"
        @click="filters('3')">
        Reptile
      </button>
    </div>
  ...
  <div class="row mt-2">
    <div
      class="col-md-4 mb-5 d-flex justify-content-center"
      v-for="item in array"
      :key="item.no">
